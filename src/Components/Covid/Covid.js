...
export const Covid = () => {
  return (
   ...
   <p> We have taken careful measures to ensure our services and the environment we are in are carefully managed, safe and ensures the health and well-being of our beauticians. We adhere to the UAE Ministry of Health and Dubai Health Authority's guidance to keep you and our staff safe.</p>
